    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="px-4 pt-1 pb-4 md:px-8 md:pt-8 flex flex-col gap-6">
        ...
        <Link href="/orders/new">
          <Card className="bg-gradient-to-br from-blue-700 to-blue-500 border-0 cursor-pointer hover:shadow-lg transition-shadow overflow-hidden text-white">
        ...
        <Card size="sm">
          <CardHeader>
            <CardTitle className="text-sm font-semibold text-gray-700">Pipeline</CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <div className="flex flex-col gap-3">
            {recentOrders.map((order) => (
              <Link key={order.orderId} href={`/orders/${order.orderId}`} className="block">
                <Card size="sm" className="hover:bg-gray-50 transition-colors cursor-pointer">
